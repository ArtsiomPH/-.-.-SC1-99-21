...
class MedcineAdmin(admin.ModelAdmin):
    list_display = ["international_name", "general_info", "general_sources", "general_documentation", "pub_date"]
...
class SynonymsAdmin(admin.ModelAdmin):
    list_display = ["comm_name", "info", "sources", "documentation", "medcine", "pub_date"]
